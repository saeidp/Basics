...
#-------------------------------------------------------------------
#another implementation of min heap
class BinHeap:
    def __init__(self):
        # 0 makes the later calculation easy
        self.heapList = [0]
        self.currentSize = 0
    def insert(self,k):
...
heapList = [31, 11, 7, 12, 15, 14, 9, 2, 3, 16]
print("Before Heapyfy: ", str(heapList))

bh = BinHeap()
bh.buildHeap(heapList)
print("After min heapify: ", str(bh.heapList[1:])) #[2, 3, 7, 11, 15, 14, 9, 12, 31, 16]
